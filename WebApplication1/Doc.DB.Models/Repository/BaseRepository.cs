...
namespace Doc.DB.Models.Repository
{
    public class BaseRepository<T> : IBaseRepository<T>
        where T : class, IEntity
    {
        // todo: вынести в конфиг
        protected string connectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\ELMA\WebApplication1\Doc.DB.Models\App_Data\DocDB.mdf;Integrated Security=True";
